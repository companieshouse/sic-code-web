...
locals {
  ...
  lb_listener_paths         = ["/sic-code-search","/sic-code-search/*"]
  healthcheck_path          = "/sic-code-search/healthcheck" #healthcheck path for sic code web
  ...
  app_environment_filename    = "sic-code-web.env"
